...
<div class="max-w-md mx-auto flex flex-col items-center mt-8">
    ...
    <form class="grid grid-cols-2 gap-4">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="prefix">
                Tussenvoegsel
            </label>
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="housenumber">
                Huisnummer
            </label>
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="province">
                Provincie
            </label>
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="postal">
                Postcode
            </label>
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="text-center col-span-2">
            <Button text="Registreren" handleClick={register}></Button>
        </div>
    </form>
    {#if errorMessage}
